...
.PARAMETER MainSolutionName
    The main solution this feature will be transported into (e.g., {mainSolutionUniqueName}).
...
.EXAMPLE
    .\Validate-FeatureTransport.ps1 -FeatureSolutionName "AB34567_StatusBadge" -MainSolutionName "{mainSolutionUniqueName}"
#>
[CmdletBinding()]
param(
    [Parameter(Mandatory)]
