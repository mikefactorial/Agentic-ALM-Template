...
- **Transport-Solution.ps1** - Includes pre-export, post-export, pre-import, post-import, pre-deploy, and post-deploy hooks  
...
- **pre-export** - Before solution export (Transport process)
- **post-export** - After solution export (Transport process)
- **pre-import** - Before solution import (Transport process)
- **post-import** - After solution import (Transport process)
- **pre-deploy** - Before solution deployment (copying components)
